...
export default function ConflictRenameDialog(props) {
  const [renameValue, setRenameValue] = createSignal(
    props.suggestedName || buildSuggestedName(props.itemName),
  );
    ...
    >
      <div class="rep-confirm docs-upload-conflict">
        ...
        <div class="docs-upload-conflict__rename">
          <label
            class="rep-form__label"
            for={props.inputId || "docs-conflict-rename"}
          >
            Nový názov
          </label>
          <input
        ...
        <div class="rep-confirm__actions docs-upload-conflict__actions">
          <button class="rep-btn rep-btn--ghost" onClick={props.onCancel}>
            {props.cancelLabel || "Zrušiť"}
          </button>
          <button
            class={props.renameButtonClass || "rep-btn rep-btn--ghost"}
          ...
          <Show when={props.onOverwrite}>
            <button class="rep-btn rep-btn--danger" onClick={props.onOverwrite}>
              {props.overwriteLabel || "Nahradiť súbor"}
            </button>
          </Show>
        </div>
      </div>
